...
// Logo hosteado en enlace público
const LOGO_URL = "https://i.postimg.cc/hPdnrTxH/Logo-Nuevo-Munich-web.png";

export async function handleIncoming(from, text) {

text = text.toLowerCase(); // ✅ Asegurar que siempre comparemos en minúsculas

// ================== BIENVENIDA ==================
if (text.includes("hola") || text.includes("inicio") || text.includes("menu") || text === "") {

// 1) Enviar logo
await sendImage(from, LOGO_URL, "");

// 2) Pausa para que WhatsApp cargue la imagen ✅
