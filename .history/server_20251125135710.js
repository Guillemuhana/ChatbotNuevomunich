...
sendRespuestaIA,
sendInicioPedidoOpciones, // ✔️ NOMBRE CORRECTO
pedirDatosDelCliente, // ✔️ EXISTE
sendPedidoConfirmacionCliente // ✔️ EXISTE
} from "./bot.js";
...
await pedirDatosDelCliente(from, msg);
return res.sendStatus(200);
}

// 11) CONFIRMACIÓN FINAL (cuando usuario manda resumen)
