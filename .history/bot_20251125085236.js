    ...
    interactive: {
      ...
      action: {
        buttons: [
          ...
          {
            type: "reply",
            reply: { id: "INICIO_PEDIDO", title: "📝 Realizar pedido" },
          },
        ],
      },
    },
    ...
    interactive: {
      ...
      action: {
        buttons: [
          ...
          {
            type: "reply",
            reply: { id: "CATALOGO_PDF", title: "📄 Catálogo PDF" },
          },
        ],
      },
    },
...
// Alias con el nombre que espera tu server.js
export async function sendInicioPedido(to) {
  return sendInicioPedidoOpciones(to);
}
