...
/* ======================================================
SUBCATEGORÍA → ENVÍA TODOS LOS PRODUCTOS (UN MENSAJE CADA UNO)
====================================================== */
...
// Enviar cada producto individualmente (DOCUMENTO HD + texto)
...
if (!urlImagen) {
// por si hay un nombre mal escrito en CATEGORIAS
const dataError = {
messaging_product: "whatsapp",
to,
type: "text",
